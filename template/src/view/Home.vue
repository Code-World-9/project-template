...
import { Classification } from "@vicons/carbon";
import { CreditScoreTwotone } from "@vicons/material";
...
<template>
  <NLayout has-sider :native-scrollbar="false" style="height: 100%">
    <NLayoutSider
      :width="272"
...
.left-sider {
  box-shadow: 16px 0px 80px rgba(0, 0, 0, 0.05);
  height: 100%;
}
.right-sider {
  box-shadow: -16px 0px 80px rgba(0, 0, 0, 0.05);
